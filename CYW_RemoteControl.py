    ...
    def receive_thread(self):
        while True:
            ...
            while True:
                ...
                self.global_db.r_iiwa_FX=self.global_db.r_iiwaFltLs[9]
                self.global_db.r_iiwa_FY=self.global_db.r_iiwaFltLs[10]
                self.global_db.r_iiwa_FZ=self.global_db.r_iiwaFltLs[11]
                self.global_db.r_iiwa_TX=self.global_db.r_iiwaFltLs[12]
                self.global_db.r_iiwa_TY=self.global_db.r_iiwaFltLs[13]
                self.global_db.r_iiwa_TZ=self.global_db.r_iiwaFltLs[14]
...
class global_database():
    ...
    def get_read_poses(self):
        return [self.r_iiwa_x/1000,self.r_iiwa_y/1000,self.r_iiwa_z/1000,self.r_iiwa_a,self.r_iiwa_b,self.r_iiwa_g,self.r_iiwa_o]
