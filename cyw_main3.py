...
def main(argv):
    ...
    while key != 113:  # for 'q' key
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            #          cube
            #          (xCoord + xEntent + thickness, yCoord + (18 + thickness * 4)), color_array[detection[3]], -1)
            cv2.putText(image," " + (str(distance) + " m") + (" x=" + str(x)) + (
                                    " y=" + str(y)) + (" z=" + str(z)),
                        (xCoord + (thickness * 4), yCoord + (10 + thickness * 4)), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                        (255, 255, 255), 2)
            # cv2.rectangle(image, (xCoord - thickness, yCoord - thickness),
            #               (xCoord + xEntent + thickness, yCoord + yExtent + thickness), color_array[detection[3]],
            #               int(thickness * 2))
