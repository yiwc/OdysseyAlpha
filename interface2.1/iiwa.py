...
home_pose=[560/1000,0/1000,460/1000,0,0,-2.9]
ACCE = 0.1
VELO = 0.002
TOL_TARGET_POSE = 0.002
class Interface:
    ...
    def move_home(self):
        print("move home")
        # self.move_tcp_absolute(self.db.get_safe_poses_in_meters())
        self.move_tcp_absolute(home_pose)
        print("move home finished")
    ...
    def stopj(self,test_num):
        ...
        # self.movj(joints,acc=ACCE,velo=VELO*4)
    ...
    def move_tcp_absolute(self, pose):
        ...
        self.ct.pos_control(sp_x=pose[0]*1000,sp_y=pose[1]*1000,sp_z=pose[2]*1000,sp_a=pose[3],sp_b=pose[4],sp_g=pose[5],sp_o=self.db.iiwa_o_sp)
    ...
    def rot_tool(self, val):
        ...
        # joints[5] = 0
        # # joints[6] = 0
        self.movj(joints, ACCE * 4, VELO * 6)
    ...
    def get_gripper(self):
        ...
        #6 open val=false
        #113 close val=true
        # print("gripper:",self.db.get_read_poses()[6]>90)
    ...
    def _force_mode_start(self, force, maxdist, duration=None, deviation=None, speed=None, damp=None):
        ...
        self.ct.ptp_force_control(pose=self.get_tcp_pose(),stifs=[300,300,300,100,100,100],addforce=[0,2,0,0,0,0],speed=0.01)
    def disconnect(self):
        return True
